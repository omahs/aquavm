...
fn test_merge_unused_mismatch() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            r#" values in call results are not equal:"#,
            r#" Unused(CID("bagaajyheaiqm6aoj3hpiz4kdhuqsvw4xxzc6z7ap3bufth5ph3shigs6swouetq"))"#,
            r#" != Unused(CID("bagaajyheaiqm4cf3ckjrcui3xl62gdl4drdcvxzm2nb6mospxz4ex3lzz66fzeq"))"#
        )
    );
}
